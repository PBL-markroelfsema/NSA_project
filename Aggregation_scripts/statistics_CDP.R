...
{ cat(paste0("# rows: ", nrow(data), "\n"))
  ...
  write.table(tmp, paste0("data/stat_", label, "_1.csv"), sep=";", row.names=FALSE)
  ...
  write.table(tmp, paste0("data/stat_", label, "_2.csv"), sep=";", row.names=FALSE)
  ...
  write.table(tmp, paste0("data/stat_", label, "_3.csv"), sep=";", row.names=FALSE)
  ...
  write.table(tmp, paste0("data/stat_", label, "_4.csv"), sep=";", row.names=FALSE)
  write.table(filter(tmp, remaing==0 & sum_percent_alloc>1), paste0("data/duplicates_", label, ".csv"), sep=";", row.names=FALSE)
  write.table(filter(tmp, remaing!=0, perc_from_closest_number>0.1), paste0("data/percent_alloc_", label, ".csv"), sep=";", row.names=FALSE)
  ...
  write.table(tmp, paste0("data/percent_alloc_one_branch_na_", label, ".csv"), sep=";", row.names=FALSE)
  }