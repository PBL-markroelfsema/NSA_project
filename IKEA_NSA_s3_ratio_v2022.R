...
acct_period_2018 <- read.xlsx("data/CDP/input/CDP_2018_Global_aggregation_raw_response.xlsx", sheet = "C0.2")
acct_period_2019 <- read.xlsx("data/CDP/input/CDP_2019_Global_aggregation_raw_response.xlsx", sheet = "C0.2")
acct_period_2020 <- read.xlsx("data/CDP/input/CDP_2020_Global_aggregation_raw_response.xlsx", sheet = "C0.2")
acct_period_2021 <- read.xlsx("data/CDP/input/CDP_2021_Global_aggregation_raw_response.xlsx", sheet = "C0.2")
base_year_em_2018 <- read.xlsx("data/CDP/input/CDP_2018_Global_aggregation_raw_response.xlsx", sheet = "C5.1")
base_year_em_2019 <- read.xlsx("data/CDP/input/CDP_2019_Global_aggregation_raw_response.xlsx", sheet = "C5.1")
base_year_em_2020 <- read.xlsx("data/CDP/input/CDP_2020_Global_aggregation_raw_response.xlsx", sheet = "C5.1")
base_year_em_2021 <- read.xlsx("data/CDP/input/CDP_2021_Global_aggregation_raw_response.xlsx", sheet = "C5.1")


#emissions data
mry_s1_em_2018_in <- read.xlsx("data/CDP/input/CDP_2018_Global_aggregation_raw_response.xlsx", sheet = "C6.1")
mry_s1_em_2019_in <- read.xlsx("data/CDP/input/CDP_2019_Global_aggregation_raw_response.xlsx", sheet = "C6.1")
mry_s1_em_2020_in <- read.xlsx("data/CDP/input/CDP_2020_Global_aggregation_raw_response.xlsx", sheet = "C6.1")
mry_s1_em_2021_in <- read.xlsx("data/CDP/input/CDP_2021_Global_aggregation_raw_response.xlsx", sheet = "C6.1")

mry_s2_em_2018_in <- read.xlsx("data/CDP/input/CDP_2018_Global_aggregation_raw_response.xlsx", sheet = "C6.3")
mry_s2_em_2019_in <- read.xlsx("data/CDP/input/CDP_2019_Global_aggregation_raw_response.xlsx", sheet = "C6.3")
mry_s2_em_2020_in <- read.xlsx("data/CDP/input/CDP_2020_Global_aggregation_raw_response.xlsx", sheet = "C6.3")
mry_s2_em_2021_in <- read.xlsx("data/CDP/input/CDP_2021_Global_aggregation_raw_response.xlsx", sheet = "C6.3")

mry_s3_em_2018_in <- read.xlsx("data/CDP/input/CDP_2018_Global_aggregation_raw_response.xlsx", sheet = "C6.5")
mry_s3_em_2019_in <- read.xlsx("data/CDP/input/CDP_2019_Global_aggregation_raw_response.xlsx", sheet = "C6.5")
mry_s3_em_2020_in <- read.xlsx("data/CDP/input/CDP_2020_Global_aggregation_raw_response.xlsx", sheet = "C6.5")
mry_s3_em_2021_in <- read.xlsx("data/CDP/input/CDP_2021_Global_aggregation_raw_response.xlsx", sheet = "C6.5")
...
write.xlsx(by_mry_2018_final, file = 'data/CDP/output/IKEA_NSA_2018_BY_MRY_s3_perc.xlsx') 
write.xlsx(by_mry_2019_final, file = 'data/CDP/output/IKEA_NSA_2019_BY_MRY_s3_perc.xlsx')
write.xlsx(by_mry_2020_final, file = 'data/CDP/output/IKEA_NSA_2020_BY_MRY_s3_perc.xlsx')
write.xlsx(by_mry_2021_final, file = 'data/CDP/output/IKEA_NSA_2021_BY_MRY_s3_perc.xlsx') 
